output "private_dns_a_records_id" {
  ...
  value       = { for k, v in azurerm_private_dns_a_record.private_dns_a_records : k => v.id }
}
output "private_dns_a_records_fqdn" {
  ...
  value       = { for k, v in azurerm_private_dns_a_record.private_dns_a_records : k => v.fqdn }
}
output "private_dns_a_records_name" {
  ...
  value       = { for k, v in azurerm_private_dns_a_record.private_dns_a_records : k => v.name }
}
output "private_dns_a_records_records" {
  ...
  value       = { for k, v in azurerm_private_dns_a_record.private_dns_a_records : k => v.records }
}
output "private_dns_a_records_resource_group_name" {
  ...
  value       = { for k, v in azurerm_private_dns_a_record.private_dns_a_records : k => v.resource_group_name }
}
output "private_dns_a_records_tags" {
  ...
  value       = { for k, v in azurerm_private_dns_a_record.private_dns_a_records : k => v.tags }
}
output "private_dns_a_records_ttl" {
  ...
  value       = { for k, v in azurerm_private_dns_a_record.private_dns_a_records : k => v.ttl }
}
output "private_dns_a_records_zone_name" {
  ...
  value       = { for k, v in azurerm_private_dns_a_record.private_dns_a_records : k => v.zone_name }
}
