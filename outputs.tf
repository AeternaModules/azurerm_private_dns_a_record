...
output "private_dns_a_records_resource_group_name" {
  ...
  value       = { for k, v in azurerm_private_dns_a_record.private_dns_a_records : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
...
output "private_dns_a_records_zone_name" {
  ...
  value       = { for k, v in azurerm_private_dns_a_record.private_dns_a_records : k => v.zone_name if v.zone_name != null && length(v.zone_name) > 0 }
}
